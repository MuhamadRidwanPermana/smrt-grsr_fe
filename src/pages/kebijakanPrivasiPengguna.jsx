...
export default function kebijakanPrivasiPengguna() {
  return (
    <body className="py-10 px-36 font-inter text-justify">
      ...
      <h1 className="text-4xl font-semibold my-5">Interpretation and Definitions</h1>
      ...
      <ul className="list-disc ml-5">
        ...
        <li>
          <p>
            <strong>Affiliate</strong> Affiliate is a marketing/business method
            where someone who serves as an affiliate will get a certain amount
            of commission after successfully promoting the product.
          </p>
        </li>
        <li>
          <p>
            <strong>Company</strong> (referred to as either "the Company", "We",
            "Us" or "Our" in this Agreement) refers to Sawarga Digital
            Indonesia, Kutamaya No.Ruko A, Kotakulon, Kec. Sumedang Sel.,
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Daftarmenu, accessible from{" "}
            <a
              href="https://daftarmenu.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://daftarmenu.com
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        You have the right to ask us to help delete the personal data we have
        collected about you.
      </p>

      <p>
        You can update, change, or delete your information at any time by
        logging into your Account if you have one, and visiting the account
        settings section that allows you to manage your personal information.
        You can also contact us to request access, correct, or delete any
      ...
      <h2 className="text-2xl font-semibold my-3">Limitation of the Number of Menus for Free Account Users</h2>
      <p>
        We are delighted that you have chosen DaftarMenu.com as your menu
      ...
      <ul className="list-disc ml-5">
        <li>
          No Deletion Will Occur: We will not delete menus that exceed the
          50-menu limit.
        </li>
        <li>
      ...
      <h1 className="text-4xl font-semibold my-5">Children's Privacy</h1>
      <p>
      ...
      <h1 className="text-4xl font-semibold my-5">Changes to this Privacy Policy</h1>
      <p>
