  ...
  return (
    <>
      <nav className="flex justify-between items-center sticky z-50 bg-white bg-opacity-70 top-0 backdrop-blur background-blur-lg  w-full h-16 p-5 lg:px-28 py-5 lg:py-10 font-inter text-blue-900">
        ...
        >
          <RxHamburgerMenu
            className={`text-2xl my-4 mx-4 cursor-pointer text-blue-900`}
          />
        </span>
        <div
          className={`inline lg:hidden bg-white w-full h-fit px-5 text-slate-500 ${
            openNavbar ? "absolute z-50 top-16 left-0" : "hidden"
          }`}
        >
          <ul
            className="mx-5 flex lg:hidden py-5 text-slate-500"
            onClick={handleClick}
          >
            <li>Harga</li>
          </ul>
        ...
        <div className="flex items-center cursor-pointer text-slate-500">
          <ul
            className="mx-5 hidden lg:flex  text-slate-500"
            onClick={handleClick}
          >
            <li>Harga</li>
          </ul>
      ...
      <a
        href="https://wa.me/+6281223918932?text=Hallo, Saya Ingin menanyakan perihal SmartGrosir"
        target="_blank"
      >
        <div className="sticky overflow-hidden top-3/4 z-30 float-right w-64 font-inter text-blue-900">
          <div className="flex items-center w-60 z-20 p-3 pr-8 rounded-s-full bg-blue-950 ml-auto -mr-40 hover:-translate-x-40 hover:duration-300 hover:delay-100">
            <img
              src={IconHeadset}
              alt=""
              className="rotate-12 w-10 h-auto mr-7"
            />
      ...
      <body className="w-full h-fit p-5 lg:px-36">
        ...
        <div className="relative z-20 lg:flex w-full h-fit justify-center lg:justify-between items-center mt-24 mb-32 lg:mt-40 lg:mb-80">
          ...
          <div className="lg:w-1/2 p-0 lg:pb-0 pb-10 lg:pr-36">
            <h1 className="lg:w-[40rem] text-3xl lg:text-5xl font-source_sans text-blue-900 pb-6 pt-5 lg:pt-0">
              Gak perlu lagi pusing mengelola data grosir!
            </h1>
            <p className="text-md lg:text-xl font-inter text-blue-900 pb-8">
              SmartGrosir memungkinkan kamu dengan mudah mengorganisir produk,
        ...
        <div className="relative z-20 lg:flex w-full justify-center lg:justify-between items-center mt-5 mb-32 lg:my-72">
          ...
          <div className="lg:w-1/2 p-0 lg:pl-36">
            <h1 className="text-3xl lg:text-5xl font-source_sans text-blue-900 pb-6">
              Analisis Data Grosir
            </h1>
            <p className="text-base lg:text-xl font-inter text-blue-900 pb-8">
              Dapatkan wawasan berharga dari analisis data grosir untuk
        ...
        <div className="relative z-20 lg:flex w-full justify-center lg:justify-between items-center mt-5 mb-32 lg:my-72">
          ...
          <div className="lg:w-1/2 p-0 lg:pb-0 pb-10 lg:pr-36">
            <h1 className="text-3xl lg:text-5xl font-source_sans text-blue-900 pb-6 pt-5 lg:pt-0 lg:w-[35rem]">
              Lebih Banyak Waktu, Lebih Banyak Pelanggan
            </h1>
            <p className="text-base lg:text-xl font-inter text-blue-900 pb-8">
              Tingkatkan layanan pelanggan Anda dengan menghemat waktu yang
        ...
        <div className="w-full justify-center items-center mt-5 lg:my-72">
          <header className="text-center mx-auto lg:w-2/3 h-fit w-full">
            <h1 className="text-3xl lg:text-5xl font-source_sans text-blue-900 pb-5 pt-5 lg:pt-0">
              Manfaatkan Kemudahan Grosir
            </h1>
            <p className="mx-auto text-lg lg:text-xl font-inter text-blue-900 lg:w-[35rem]">
              SmartGrosir - Solusi terbaik untuk mengelola bisnis grosir Anda
              tanpa kerumitan.
            </p>
          </header>
          <body className="lg:flex mb-36 mt-20 grid gap-8">
            <div className="w-full bg-blue-50 rounded-xl p-7">
              ...
              <h1 className="text-2xl text-blue-900 font-source_sans my-5">
                Optimalkan Bisnis Grosir Anda
              </h1>
              <p className="text-base text-slate-400 my-5 font-inter">
                Kelola data grosir dengan efisien dan tingkatkan produktivitas
                bisnis Anda.
              </p>
            </div>
            <div className="w-full bg-blue-50 rounded-xl p-7">
              <img src={IconFolder} alt="" className="mt-5 mb-7" />
              <h1 className="text-2xl text-blue-900 font-source_sans my-5 pr-5">
                Sederhana dan Efisien
              </h1>
              <p className="text-base text-slate-400 my-5 font-inter">
                Pengelolaan informasi grosir menjadi lebih sederhana dan efisien
                daripada sebelumnya.
              </p>
            </div>
            <div className="w-full bg-blue-50 rounded-xl p-7">
              ...
              <p className="text-base text-slate-400 my-5 font-inter">
                Sesuaikan platform kami dengan kebutuhan bisnis Anda untuk hasil
                terbaik.
              </p>
            </div>
            <div className="w-full bg-blue-50 rounded-xl p-7">
              ...
              <p className="text-base text-slate-400 my-5 font-inter">
                Tim kami siap membantu Anda dalam mengoptimalkan penggunaan
                platform kami.
              </p>
            </div>
          </body>
        ...
        <div className="w-full h-fit mx-auto align-center grid justify-center items-center mt-5 mb-10 my-72">
          <header className="mx-auto text-center lg:w-3/4 h-fit w-full">
            <h1 className="text-3xl lg:text-5xl font-source_sans text-blue-900 pb-5 pt-5 lg:pt-0">
              Solusi yang Didesain Sesuai Kebutuhan
            </h1>
            <p className="text-lg lg:text-xl font-inter text-blue-900">
              Platform kami disesuaikan untuk memenuhi kebutuhan unik bisnis
              grosir Anda.
            </p>
          </header>
          <span ref={ref}></span>
          <body className="lg:flex mb-36 mt-20 font-inter">
            <div className="lg:mx-5 lg:mb-0 mb-10 w-96 h-fit p-10 border-2 border-slate-300 rounded-xl">
              <header>
                <div className="flex">
                  ...
                  />
                  <span className="text-xs text-blue-400 -mt-1 w-9 h-6 mx-1.5 text-center pt-0.5 bg-blue-100 border border-blue-400 rounded-md">
                    Lite
                  </span>
                </div>
                <div>
            ...
            <div className="lg:mx-5 w-96 h-auto p-10 border-2 border-blue-950 rounded-xl">
              <header>
                <div className="flex">
                  <img
                    ...
                    className="lg:w-52 lg:-mt-2 w-40 -mt-2"
                  />
                  <span className="text-xs text-white -mt-1 w-16 h-6 mx-1.5 text-center pt-1 bg-blue-950 rounded-md">
                    Premium
                  </span>
                </div>
                <div>
                  ...
                  <p className="text-4xl text-blue-950 font-semibold my-3">
                    Rp. 75k/3 bulan
                  </p>
                </div>
              </header>
              ...
              <div>
                <a
                  href=""
                  className="mt-7 justify-center flex bg-blue-950 text-white w-full h-9 rounded-lg items-center cursor-pointer"
                >
